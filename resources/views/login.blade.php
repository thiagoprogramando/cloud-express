                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="pt-4 pb-2">
                          ...
                          <p class="text-center small">Faça login para ter aos benefícios da sua conta.</p>
                      </div>
                      ...
                      <form action="{{ route('logon') }}" method="POST" class="row g-3">
                          ...
                          <div class="col-12">
                            ...
                            <a href="{{ $authGoogle }}" title="Acessar com sua conta Google" class="btn btn-primary w-100 mt-2" type="submit"><i class="bx bxl-google bx-sm"></i></a>
                          </div>
