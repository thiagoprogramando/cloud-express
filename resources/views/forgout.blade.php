                            ...
                            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                                ...
                                @if(empty($code))
                                    <div class="card mb-3">
                                        <div class="card-body">
                                            <div class="pt-4 pb-2">
                                                <h5 class="card-title text-center pb-0 fs-4">Podemos te ajudar!</h5>
                                    ...
                                    <div class="card mb-3">
                                        <div class="card-body">
                                            ...
                                            <form action="{{ route('recovery-password') }}" method="POST" class="row g-3">
                                                @csrf
                                                <div class="col-12">
                                                    <input type="hidden" name="code" class="form-control" placeholder="Código" value="{{ $code }}">
                                                </div>
                                                <div class="col-12">
                                ...
                                <div class="credits">
                                    EXPRESS SOFTWARE CLUBE v 0.0.1
                                </div>
                            </div>
                        </div>
                    </div>
